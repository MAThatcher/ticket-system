...
app.get("/", (req,res) =>{
    const userTickets =
        "SELECT userName, ticket.ticketId, ticket.userId, ticketDate, messageText " +
        "FROM users, ticket, ticketMessage " +
        "WHERE users.userId = ticket.userId " +
        "AND ticket.ticketId = ticketMessage.ticketId " +
        "AND ticket.userId = 'user1@email.com' " +
